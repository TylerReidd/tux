...
import { Button280, Button350, LoginBtn, MedBtn, DisabledBtn, Button, GoogleBox, GoogleG, PlainBtn, LinkBtn  } from "./Buttons";
...
export const PlainButton = () => <PlainBtn>PlainBtn</PlainBtn>;

export const LinkButton = () => <LinkBtn>Link</LinkBtn>
